...
4. Open the `main.ipynb` notebook. Select the specific video you want to use from the `SampleVideos` folder or use your own video if you have trained your custom dataset. Download additonal `SampleVideos` - [GoogleDrive](https://drive.google.com/drive/folders/1tm5oBWeoIEatEPcZPzjyzcDNIfhwLZxd?usp=share_link)
